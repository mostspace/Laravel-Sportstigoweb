  ...
  <div class="main-section pt-4 pb-4">
    ...
    <table class="rs-table refferal-users w-100 text-center">
      <tr class="shadow-none h-auto">
        ...
        <th>Total Earned</th>
        <th>Mobile No</th>
        <!--<th>Total Payout | Total Balance</th>!-->
        <th>Total Balance</th>
        <th>Email</th>
        <th>Name</th>
      </tr>
	...
	@forelse( $userdetails as $userdetailsvalue ) 
        ...
        <!--<td>
          <div class="action-btns">
		    <a href="{{ route('refferalview', $userdetailsvalue->id ) }}" class="view-btn">
            ...
            <a href="{{ route('refferaledit', $userdetailsvalue->id ) }}" class="edit-btn">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <a href="{{ route('refferaldelete', $userdetailsvalue->id ) }}" class="delete-btn">
        ...
        <td><span class="total-earned">RM {{$userdetailsvalue['earning']}}</span></td>
        <td>{{$userdetailsvalue['mobile']}}</td>
        <!--<td>RM {{ ((int)$userdetailsvalue->wallet_amount - (int)$userdetailsvalue->earning)}}  | RM {{$userdetailsvalue['wallet_amount']}}</td>!-->
        <td>RM {{$userdetailsvalue['wallet_amount']}}</td>
...
<script>
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('sortingrefferallist',['',''])}}" +"/"+txtval+"/"+sortval ;
