...
<div class="dash wrapper">
    ...
    <div class="main-section pt-4 pb-4">
      <div class="container">
        ...
        <form action="{{ route('salesagentprofileupdate',$usrlist->id)}}" method="post"  enctype="multipart/form-data">
          @csrf 
     ...
     <div class="row d-flex align-items-center justify-content-start mb-4">
        <button type="submit" class="theme-btn mr-2">SAVE</button>
          ...
          <div class="row">
			...
			<div class="col-lg-12">
              <div class="form-group row">
                ...
                <div class="col-lg-6">
                  <input type="text" name = "bankname" class="custom-field w-100 form-control" value="{{ $usrlist->bankname }}" readonly>
			...
			<div class="col-lg-12">
              <div class="form-group row">
                ...
                <div class="col-lg-6">
                  <input type="text" name = "bankacno" class="custom-field w-100 form-control" value="{{ $usrlist->bankacno }}" readonly>
			...
			<div class="col-lg-12">
              <div class="form-group row">
                ...
                <div class="col-lg-6">
                  <input type="text" name = "bankaccountname" class="custom-field w-100 form-control" value="{{ $usrlist->bankaccountname }}" readonly>
