	...
	@forelse( $userdetails as $userdetailsvalue )  
        ...
        <td>
          <div class="action-btns">
		    <!--<a href="{{ route('hostview', $userdetailsvalue->host_id  ) }}" class="view-btn">
            ...
            <a href="{{ route('hostedit', $userdetailsvalue->host_id  ) }}" class="edit-btn">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <!--<a href="{{ route('hostdelete', $userdetailsvalue->host_id  ) }}" class="delete-btn">!-->
           <a href="javascript:void(0)" id="del{{$userdetailsvalue->host_id}}" onclick="deleteuserfun({{$userdetailsvalue->host_id}})" data-userid="" class="delete-btn">

			<!--<a href="javascript:void(0)" onclick="" data-userid="{{$userdetailsvalue['user_id']}}" class="delete-btn">!-->
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <td>{{$userdetailsvalue['host_game_name']}}</td>
        <td>{{$userdetailsvalue['totalplayer']}}</td>
        <!--<td>{{$userdetailsvalue['venuename']}}</td>!-->
		
		<?php 
		$s = $userdetailsvalue->hostexpired; 
		if($s=='Y')
		{
			$status = 'Expired';
...
<script>
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('sortinghostlist',['',''])}}" +"/"+txtval+"/"+sortval ;
				window.location.href=url;
