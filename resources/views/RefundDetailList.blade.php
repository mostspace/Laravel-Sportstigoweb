...
<div class="dash wrapper">
  ...
  <div class="main-section pt-4 pb-4">
    ...
    <table class="rs-table refferal-users text-center">
      <tr class="shadow-none h-auto">
        <th>Actions</th>
       
        <th>Refund Policy Description</th>
		<th>Refund Policy Hours</th>
		<th>Created Date</th>
      </tr>
	...
	@forelse( $statelist as $userdetailsvalue )
        ...
        <td>
          <div class="action-btns">
            ...
            <a href="{{ route('refundpolicyedit', $userdetailsvalue->id ) }}" class="edit-btn">
           ...
           <!--<a href="{{ route('deleterefundpolicy', $userdetailsvalue->id ) }}" class="delete-btn">!-->
...
<script>
  ...
  function deleteuserfun(btn){
	...
	var txt;
	  ...
	  {
		var url = "{{ route('deleterefundpolicy', '') }}"+"/"+btn ;
