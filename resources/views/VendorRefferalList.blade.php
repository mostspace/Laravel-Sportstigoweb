	...
	@forelse( $userdetails as $userdetailsvalue ) 
        ...
        <td>
          <div class="action-btns">
            ...
            <a href="{{ route('vendorrefferaledit', $userdetailsvalue->id ) }}" class="edit-btn">
            ...
            <!--<a href="{{ route('vendorrefferaldelete', $userdetailsvalue->id ) }}" class="delete-btn">!-->
...
<script>
  ...
  function deleteuserfun(btn){
	...
	var txt;
	  ...
	  {
		var url = "{{ route('vendorrefferaldelete', '') }}"+"/"+btn ;
