  ...
  <div class="main-section pt-4 pb-4">
	...
	?>
	 ...
	 @csrf
      ...
      <div><a href="{{ route('instructorreport') }}"><button type="button" class="d-inline sgreen mr-2" >Instrutor Report</button></a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
	...
	@forelse( $userdetails as $userdetailsvalue ) 
        ...
        <td>
          <div class="action-btns">
           ...
           <a href="{{ route('instructoredit', $userdetailsvalue->instructor_id ) }}" class="edit-btn">
            ...
            <!--<a href="{{ route('instructordelete', $userdetailsvalue->instructor_id ) }}" class="edit-btn">!-->
            <a href="javascript:void(0)" id="del{{$userdetailsvalue->instructor_id}}" onclick="deleteuserfun({{$userdetailsvalue->instructor_id}})" data-userid="" class="delete-btn">
		...
		<td>{{$userdetailsvalue['user_name']}}</td>
		<td>{{$userdetailsvalue['sportcenter']}}</td>
    <!--<td>{{$userdetailsvalue['instructoramt']}}</td>
    <td>{{$userdetailsvalue['hireme']}}</td>!-->
        <td><!--<span class="user-box"><img src="<?php echo asset('assets/img/user.jpg'); ?>" class="user-img ml-2"></span>!--></td>
      </tr>
...
<script>
  ...
  function deleteuserfun(btn){
	...
	var txt;
	  ...
	  {
		var url = "{{ route('instructordelete', '') }}"+"/"+btn ;
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('sortinginstructorslist',['',''])}}" +"/"+txtval+"/"+sortval ;
				window.location.href=url;
