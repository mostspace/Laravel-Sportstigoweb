	...
	@forelse( $userdetails as $userdetailsvalue ) 
        ...
        <td>
          <div class="action-btns">
            ...
            <a href="{{ route('vendorstaffedit', $userdetailsvalue->id ) }}" class="edit-btn">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <a href="{{ route('vendorstaffdelete', $userdetailsvalue->id ) }}" class="delete-btn">
...
<script>
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('vendorsortingstafflist',['',''])}}" +"/"+txtval+"/"+sortval ;
