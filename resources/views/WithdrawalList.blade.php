...
<div class="dash wrapper">
  ...
  <div class="main-section pt-4 pb-4">
	 ...
	 @csrf
      ...
      <div class="d-flex justify-content-end ">
		...
		<input type="button" name="search" value="Search" onclick="funsorting();">
			...
			<option value="0" <?php if (isset($utype) && $utype=="0") echo "selected";?> >Refferal User</option>
			<option value="3" <?php if (isset($utype) && $utype=="3") echo "selected";?> >Vendor</option>    
			<option value="4" <?php if (isset($utype) && $utype=="4") echo "selected";?> >Instructor</option> 
			<option value="7" <?php if (isset($utype) && $utype=="7") echo "selected";?> >Sales Agent</option> 
      <option value="8" <?php if (isset($utype) && $utype=="8") echo "selected";?> >Vendor Refferal</option> 
    ...
    <table class=" rs-table w-100 refferal-users text-center">
	...
	@forelse( $withdrawaldetails as $userdetailsvalue ) 
        ...
        <td>
          <div class="action-btns">
			...
			<a href="{{ route('editwithdrawal', $userdetailsvalue->withdrawal_id ) }}" class="edit-btn">
           ...
           <!--<a href="{{ route('deletewithdrawal', $userdetailsvalue->withdrawal_id ) }}" class="delete-btn">
        ...
        <?php 
		$s = $userdetailsvalue->withdrawal_status; 
		if($s==0)
		{
			$status = 'Pending';
			echo '<td><span class="total-pending">'.$status.'</span></td>';
		...
		<td >{{$requesttype}}</td>
		<td >{{$userdetailsvalue->withdrawal_amount}}</td>
...
<script>
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('sortingwithdrawallist',['','',''])}}" +"/"+txtval+"/"+sortval+"/"+utype ;
