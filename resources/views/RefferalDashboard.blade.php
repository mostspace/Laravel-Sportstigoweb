  ...
  <div class="main-section pt-4 pb-4">
    <div class="container">
      <div class="row align-items-center justify-content-center">
          <div class="col-md-3">
		  <a href="{{route('salesagentprofile')}}">
          <div class="black-box">
          ...
          <div class="black-box">
            <div><span class="main-text">REPORTS</span></div>
            <div><span class="sub-text">Sales & Commision</span></div>
          </div></a>
        </div>
        ...
        <div class="black-box">
          ...
          <div><span class="sub-text">Manage Withdrawal</span></div>
        </div>
      </div>
      </div>
      <div class="row align-items-center justify-content-center">
		...
		<a href="{{route('noticboard')}}">     
		 <div class="black-box">
            <div><span class="main-text">Contact Us</span></div>
            <div><span class="sub-text">Contact Support</span></div>
          </div></a>
        </div>
	   ...
	   <div class="col-md-3">
		<a href="{{route('vendorrefferalcreate')}}">
        <div class="black-box">
          <div><span class="main-text">VENDOR REFFERAL</span></div>
          <div><span class="sub-text">Register Vendor Refferal</span></div>
        </div></a>
      </div>
