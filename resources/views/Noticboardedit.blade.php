...
<div class="dash wrapper">
  ...
  @include('layouts.header')
    ...
    <div class="custom-border"></div>
	 ...
	 @forelse( $noticdetails as $usrlist) 
	 
    <form name ="form1" action="{{ route('savereditequestnotice',$usrlist->notice_id)}}" method="post" enctype="multipart/form-data">
        @csrf 
        ...
        <div class="col-md-5">
            <div class="row align-items-center">
                ...
                <div class="col-md-8 p-0">
                    <input type="text" class="custom-field form-control" value="{{ $usrlist->title }}" name="title">
					<input type="hidden" class="custom-field form-control" value="{{ $usrlist->notice_id}}" name="notice_id">
					@if ($errors->has('title'))
      ...
      <div class="row mt-2">
        <div class="col-md-5">
            <div class="row align-items-center">
                ...
                <div class="col-md-8 p-0">
                    <textarea id="subject" rows="8" cols="50" name="subject" class="form-control custom-area" placeholder="Write something.."  >{{ $usrlist->message }}</textarea>
