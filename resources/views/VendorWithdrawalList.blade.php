...
<div class="dash wrapper">
  ...
  <div class="main-section pt-4 pb-4">
    ...
    <table class="table table-responsive refferal-users w-100 text-center">
	...
	@forelse( $withdrawaldetails as $userdetailsvalue ) 
        ...
        <td>
          <div class="action-btns">
			...
			<!--<a href="{{ route('vendoraddwithdrawal', $userdetailsvalue->withdrawal_id ) }}" class="view-btn">
			...
			<a href="{{ route('vendoreditwithdrawal', $userdetailsvalue->withdrawal_id ) }}" class="edit-btn">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <!--<a href="{{ route('vendordeletewithdrawal', $userdetailsvalue->withdrawal_id ) }}" class="delete-btn">
...
<script>
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('vendorsortingwithdrawallist',['',''])}}" +"/"+txtval+"/"+sortval ;
 ...
 function funsorting()
 {
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = '';
				var url = "{{route('vendorwithdrawallist')}}";
