...
<?php $pageheading = 'EDIT PRODUCTS';?>
<body>
   <div class="dash wrapper">
      @include('layouts.header')
      <div class="custom-border"></div>
      <form action="{{url('/product/update/'.$product['0']->id) }}" method="post"  enctype="multipart/form-data">
         @csrf
         <div class="main-section pt-4 pb-4">
            <div class="container">
               <div class="row d-flex flex-wrap align-items-center justify-content-md-start justify-content-center mb-4">
                  ...
                  <button type="submit" class="green-small mr-2 mb-2">UPDATE</button>
               ...
               <div class="row">
                  <div class="col-lg-4">
                     <div class="form-group">
						...
						<input type="text" class="form-control" value="{{$product['0']->p_name}}" name="p_name" maxlength="50">
						@error('p_name')
                  ...
                  <div class="col-lg-4">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$product['0']->p_price}}" name="p_price" maxlength="50">
						@error('p_price')
					<span class="field_error" style="color:red;">{{$message}}</span>
					@enderror
                     </div>
                  ...
                  <div class="col-lg-4">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$product['0']->p_desc}}" name="p_desc">
						@error('p_desc')
					<span class="field_error" style="color:red;">{{$message}}</span>
					@enderror
                     </div>
                  ...
                  <div class="col-lg-4">
					...
					<span class="field_error" style="color:red;">{{$message}}</span>
					@enderror
               <img src="{{asset('/NewProductImages/'.$product['0']->p_image)}}" width="50%px" alt=""/>
                     </div>
                  </div>
                  <div class="col-lg-4">
                     <div class="form-group">
                        <label for="moredetails" class="custom-label">Product Stock</label>
                        <input type="text" class="form-control" value="{{$product['0']->p_stock}}" name="p_stock">
						@error('p_stock')
					<span class="field_error" style="color:red;">{{$message}}</span>
					@enderror
					</div>
