...
<div class="dash wrapper">
  ...
  <div class="main-section pt-4 pb-4">
	...
	@forelse( $membershipsdetails as $userdetailsvalue ) 
        ...
        <td>
          <div class="action-btns">
            ...
            <a href="{{ route('membershipedit', $userdetailsvalue->membership_id  ) }}" class="edit-btn">
           ...
           <a href="{{ route('membershipdelete', $userdetailsvalue->membership_id  ) }}" class="delete-btn">
        ...
        <td>{{$userdetailsvalue['package_name']}}</td>
		<td>{{$userdetailsvalue['package_price']}}<!--<span class="user-box"><img src="<?php echo asset('assets/img/user.jpg'); ?>" class="user-img ml-2"></span>!--></td>
      </tr>
...
<script>
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('sortingmembershiplist',['',''])}}" +"/"+txtval+"/"+sortval ;
