    ...
    <div class="main-section pt-4 pb-4">
      <div class="container">
        <div class="row d-flex align-items-center justify-content-start mb-4">
		  ...
		  <button type="submit" class="green-small mr-2 mb-2" disabled>SAVE</button>
		...
		<div class="row">
            <div class="col-lg-12">
              <div class="form-group row">
                ...
                <div class="col-lg-6">
                  ...
                  <input type="text" class="custom-field w-100 form-control" name="staffname" value="{{ $usrlist->name }}" disabled>
                </div>
            ...
            <div class="col-lg-12">
              <div class="form-group row">
                ...
                <div class="col-lg-6">
                  <input type="text" class="custom-field w-100 form-control" name="username" value="{{ $usrlist->email }}" disabled>
                </div>
            ...
            <div class="col-lg-12">
              <div class="form-group row">
                ...
                <div class="col-lg-6">
                  <input type="password" class="custom-field w-100 form-control" value="{{ $usrlist->original_password }}" name="stafpassword" disabled>
		...
		<div class="col-md-4 form-check custom-check text-right">
					<input class="form-check-input" type="checkbox" disabled onclick="is_checked(this,{{$moduledtvalue['id']}})" value="{{$moduledtvalue['moduleroute']}}" <?php 
