...
<div class="dash wrapper">
  ...
  <div class="main-section pt-4 pb-4">
	...
	@forelse( $categorylist as $userdetailsvalue )
        ...
        <td>
          <div class="action-btns">
            ...
            <a href="{{ route('categoryedit', $userdetailsvalue->id ) }}" class="edit-btn">
           ...
           <!--<a href="{{ route('deletecategory', $userdetailsvalue->id ) }}" class="delete-btn">!-->
		...
		@if( $userdetailsvalue->image=='myimagepath')
		<img src="{{asset('backend/img/thumb.png')}}" alt="Blog-image" />	
		@else
			<img src="{{asset($userdetailsvalue->image)}}" width="50px" alt="Blog-image" />
	    ...
	    @if( $userdetailsvalue->image2=='myimagepath')
		<img src="{{asset('backend/img/thumb.png')}}" alt="Blog-image" />		
	
		@else
		<img src="{{asset($userdetailsvalue->image2)}}" width="50px" alt="Blog-image" />
		@endif													
		</td>
...
<script>
  ...
  function deleteuserfun(btn){
	...
	var txt;
	  ...
	  {
		var url = "{{ route('deletecategory', '') }}"+"/"+btn ;
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('sortingcategorylist',['',''])}}" +"/"+txtval+"/"+sortval ;
				window.location.href=url;
