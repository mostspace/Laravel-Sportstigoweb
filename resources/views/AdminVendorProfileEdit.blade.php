...
<body>
   ...
   <div class="container">
      ...
      <form action="{{ route('updatevendor',$vlist->vendor_id) }}" method="post" enctype="multipart/form-data">
         @csrf 
       ...
       <div class="row d-flex align-items-center mb-4">
                  ...
                  ?>  
                     ...
                     <button type="submit" class="green-small">SAVE</button>
                     </div>
                  <?php
                  }
                  ?> 
               ...
               <a href="{{ route('dashboard') }}" class="d-inline"><button type="button" class="gray-small mr-4" > BACK</button></a>  
               <a href="{{ route('vendorlist') }}" class="d-inline"><button type="button" class="green-small mr-2" > VENDOR LIST</button></a>
               ...
               <?php 
                  ...
                  if($role==1)
                  {
                    ...
                    <div class="col-lg-6 text-right ">
                     <a href="{{ route('vendorapproved', $vlist->vendor_id )}}"><button type="button" class="green-round-btn mr-2">APPROVE</button></a>
                     <a href="{{ route('vendorrejected', $vlist->vendor_id )}}"><button type="button" class="red-round-btn">SUSPEND</button></a>
                     </div>
                  <?php
                  }
                   ?>  
		...
		<div class="row">
            ...
            <?php 
               $role = Session::get('getsessionrole');
               if($role==3 || $role==6 || $role==7  || $role==8 )
               {
            ?>
				...
				<div class="col-lg-4">	  
				  <div class="form-group">
                  <label for="bankname" class="custom-label">Bank Name</label>
                  <input type="text" class="form-control" value="{{ $vlist->bankname}}" name="bankname" readonly>
              </div>
				</div>
            ...
            <div class="col-lg-4">
               <div class="form-group">
                  <label for="bankacno" class="custom-label">Account No</label>
                  <input type="text" class="form-control" value="{{ $vlist->bankacno}}" name="bankacno" readonly>
               </div>
            </div>
            ...
            <div class="col-lg-4">
               <div class="form-group">
                  <label for="bankaccountname" class="custom-label">Account Holder Name</label>
                  <input type="text" class="form-control" value="{{ $vlist->bankaccountname}}" name="bankaccountname" readonly>
               </div>
            </div>  
                  ...
                  <div class="file-upload iuw3">
                    <div class="image-upload-wrap" >
					 ...
					 @if( $vlist->image2 )
							...
							<img src="{{asset($vlist->image2)}}" width="100px" alt="Blog-image" />
                                            </div>
                                        </div>
                                    </div>
					 @endif  
        ...
        <!--<div class="custom-radio col-md-8 mb-2">
              <input type="checkbox" name="Vendor_Reffer_commisionval" id="Vendor_Reffer_commisionval" {{ ($vlist->vendor_reffer_commisionval == 'Y') ? "checked" : "" }} value="Y">
        ...
        <div class="col-lg-8">	  
				  <div class="form-group">
					...
					@foreach($allvendorrefferallist as $allvendorrefferallst)
						<option value="{{ $allvendorrefferallst->id }}" {{$vlist->vendorrefferalid == $allvendorrefferallst->id  ? 'selected' : ''}}>{{ $allvendorrefferallst->name}}</option>
					@endforeach
