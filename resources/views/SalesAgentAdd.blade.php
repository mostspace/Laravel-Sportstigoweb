...
<div class="dash wrapper">
    ...
    <form action="{{ route('salesagentadd')}}" method="post"  enctype="multipart/form-data">
          @csrf 
    ...
    <div class="main-section pt-4 pb-4">
      <div class="container">
        ...
        <a href="{{route('salesagentlist')}}"><button type="button" class="theme-btn">SALES AGENT LIST</button></a>
        </div>
