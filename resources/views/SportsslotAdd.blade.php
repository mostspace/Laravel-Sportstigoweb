...
<div class="dash wrapper">
    ...
    <div class="main-section pt-4 pb-4">
      <div class="container">
        ...
        <form action="{{ route('spotsslotadd')}}" method="post"  enctype="multipart/form-data">
          @csrf 
                    ...
                    <div class="col-md-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 p-0">
                                <input type="text" class="custom-field form-control d-inline" value="{{ old('slotname') }}" name="slotname">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 p-0">
                                <select class="form-control sportigo-select d-inline w-auto mr-2" aria-label="Default select example" name="status" value="{{ old('status') }}">
                                  <option selected>Open for Booking</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 p-0">
                                <textarea id="slotdesc" name="slotdesc" class="form-control d-inline slot-area" placeholder="Max 60 character" ></textarea>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 p-0">
                                <input type="text" class="custom-field form-control d-inline" value="{{ old('original_price') }}" name="original_price">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="custom-field w-170 form-control d-inline" value="{{ old('discount_price') }}" name="discount_price">
                            ...
                            <div class="col-md-5 p-0">
								...
								<div class="mb-2 d-flex">
								  <input type="time" class="form-control" value="{{ old('stime') }}"  name="stime">
