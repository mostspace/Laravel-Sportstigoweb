...
<div class="dash wrapper">
  ...
  <div class="main-section pt-4 pb-4">
    ...
    <table class="table rs-table refferal-users w-100 text-center">
	...
	@forelse( $userdetails as $userdetailsvalue ) 
        ...
        <td>
          <div class="action-btns">
		    <!--<a href="{{ route('staffview', $userdetailsvalue->id ) }}" class="view-btn">
            ...
            <a href="{{ route('staffedit', $userdetailsvalue->id ) }}" class="edit-btn">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="javascript:void(0)" id="del{{$userdetailsvalue->id}}" onclick="deleteuserfun({{$userdetailsvalue->id}})" data-userid="{{$userdetailsvalue['id']}}" class="delete-btn">
           <!--<a href="{{ route('staffdelete', $userdetailsvalue->id ) }}" class="delete-btn">!-->
...
<script>
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('sortingstafflist',['',''])}}" +"/"+txtval+"/"+sortval ;
				window.location.href=url;
