...
<div class="dash wrapper">
  ...
  <div class="main-section pt-4 pb-4">
	...
	@forelse( $sportsslotpricesdetails as $userdetailsvalue ) 
        ...
        <td>
          <div class="action-btns">
            ...
            <a href="{{ route('sportslotedit', $userdetailsvalue->slot_id ) }}" class="edit-btn">
           ...
           <a href="{{ route('sportslotdelete', $userdetailsvalue->slot_id ) }}" class="delete-btn">
        ...
        <td>{{$userdetailsvalue['slotname']}}</td>
		<td>{{$userdetailsvalue['slotdesc']}}</td>
		<td>{{$userdetailsvalue['original_price']}}<!--<span class="user-box"><img src="<?php echo asset('assets/img/user.jpg'); ?>" class="user-img ml-2"></span>!--></td>
      </tr>
...
<script>
  ...
  var txtval = document.getElementById("txtserach").value; 
	...
	if (txtval == null ||
                ...
                txtval.length == 0) {
                txtval = 'Search';
				var url = "{{route('sortingspotsslotlist',['',''])}}" +"/"+txtval+"/"+sortval ;
