...
<div class="dash wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="row d-flex align-items-center justify-content-between mx-4">
        <div class="d-flex">
          <div class="black-box">
            ...
            <div><span class="sub-text">Vendor Sales Report</span></div>
          </div>
        ...
        <a href = "{{ route('vendoronlinesalesreport') }}" class="mb-md-0 mb-2">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <div class="purple-outer d-flex align-items-center w-100">
              <div>
          ...
          <div class="col-md-4">
            <div class="blue-outer d-flex align-items-center w-100">
              <div>
          ...
          <div class="col-md-4">
            <div class="green-outer d-flex align-items-center w-100">
              <div>
          ...
          ?>
              <div class="col-md-4">
                <div class="colorless-outer d-flex align-items-center">
                  ...
                  <div class="ml-2">
                    <div><span class="color-main-text">Sales Agent Commision</span></div>
