...
<div class="dash wrapper">
	...
	<form action="{{ route('vendorstaffupdate',$usrlist->id) }}" method="post"  enctype="multipart/form-data">
          @csrf 
    ...
    <div class="main-section pt-4 pb-4">
      <div class="container">
        <div class="row d-flex align-items-center justify-content-md-start justify-content-center mb-4">
          ...
          {
             ?>
            <a href="{{route('vendorstafflist')}}"><button type="button" class="theme-btn mr-2">STAFF LIST</button></a>
            <?php
